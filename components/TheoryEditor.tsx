...
const useTheoryEditorLogic = () => {
    ...
    // Reset when theory changes (e.g. navigation)
    useEffect(() => {
        if (existingTheory) {
...
const EditorHeader: React.FC = () => {
    const { existingTheory, language, touched, handleCancel, handleSave } = useTheoryEditor();
...
const MainInfoForm: React.FC = () => {
    const { formState, handleChange } = useTheoryEditor();
...
const MetadataForms: React.FC = () => {
    const { formState, handleChange, categories, dangerLevels, tagInput, setTagInput, handleAddTag, handleRemoveTag } = useTheoryEditor();
